        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-body box-profile">
                    <form role="form" action="{{url('admin/permission/group/update')}}" method="post" target="nm_iframe" id="myform" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            <div class="form-group has-warning">
                                ...
                                <input type="text" class="form-control" placeholder="权限组名称" required name="name"
