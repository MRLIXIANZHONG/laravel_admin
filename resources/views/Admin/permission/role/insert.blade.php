        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-body box-profile">
                    <form role="form" action="{{url('admin/permission/role/insert')}}" method="post" target="nm_iframe"
                        ...
                        <div class="box-body">
                            <div class="form-group has-warning">
                                ...
                                <input type="text" class="form-control" placeholder="角色名称" required name="name">
                            </div>
