        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-body box-profile">
                    <form role="form" action="{{url('admin/permission/navigation/create')}}" method="post" target="nm_iframe" id="myform" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select name="permission_id" class="form-control">
                                    ...
                                    @foreach($allPermissions as $v)
                                        <option value="{{$v->id}}">{{$v->display_name ? "{$v->display_name}($v->name)" : $v->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="number" size="1" maxlength="4" minlength="" class="form-control"
                                       placeholder="排序,越小排名越前" name="sequence">
                            </div>
                        </div>
