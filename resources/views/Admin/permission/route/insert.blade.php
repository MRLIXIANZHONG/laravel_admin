        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-body box-profile">
                    <form role="form" action="{{url('admin/permission/route/insert')}}" method="post" target="nm_iframe" id="myform" enctype="multipart/form-data">
                        <input type="hidden" name="_method" value="PUT" >
                        {{csrf_field()}}
                        <div class="box-body">
                            <div class="form-group has-warning">
                                <label><i class="fa fa-check"></i>名称</label>
                                <input type="text" class="form-control" placeholder="路由名称" required name="display_name">
                            </div>
                            <div class="form-group has-warning">
                                <label><i class="fa fa-check"></i>路由地址</label>
                                <input type="text" class="form-control" placeholder="路由地址" required name="name">
                            </div>
                            <div class="form-group">
                                <label>icon</label>
                                <input type="text" class="form-control" placeholder="icon-暂未使用" name="icon">
                            </div>
                            <div class="form-group">
                                <label>描述</label>
                                <input type="text" class="form-control" placeholder="路由描述" name="description">
                            </div>
                        </div>
