    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-default">
                <div class="box-body">
                    <form role="form" action="{{url('admin/site/site_level_add')}}"  method="post" target="nm_iframe" id="myform" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            <div class="form-group has-warning">
                                ...
                                <input type="text" class="form-control" name="field_label" value="" required>
                            </div>

                            <div class="form-group has-warning">
                                <label><i class="fa fa-check"></i>顶级域名</label>
                                <input type="text" class="form-control" name="top_label" value="" required>
                            </div>
                            ...
                            @if(getAuth()->siteid == \App\Models\User::SUPERADMIN)
                                ...
                                <div class="form-group has-warning">
                                    ...
                                    <input type="text" class="form-control" id="over_time" name="over_time" value="" required>
                                </div>
