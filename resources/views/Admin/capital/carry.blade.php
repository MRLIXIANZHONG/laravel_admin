        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-body box-profile">
                    <form role="form" action="{{url('admin/capital/carry')}}" method="post" target="nm_iframe"
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group has-warning">
                                ...
                                <input type="text" class="form-control" placeholder="提现金额" required name="money">
                            </div>
                        ...
                        <div class="box-footer">
                            ...
                            <button type="submit" class="btn btn-primary" id="id_submit" name="nm_submit">提现</button>
                        </div>
                    </form>
