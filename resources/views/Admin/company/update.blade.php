                    ...
                    <form role="form" method="post" target="nm_iframe" id="myform" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group col-xs-12 col-sm-6 col-md-6 has-warning">
                                ...
                                <input type="text" class="form-control" name="add" value="{{$info->add}}" required>
                            </div>
                            <div class="form-group col-xs-12 col-sm-6 col-md-6 has-warning">
                                <label><i class="fa fa-check"></i>联系人</label>
                                <input type="text" class="form-control" name="liaison" value="{{$info->liaison}}" required>
                            </div>
                            <div class="form-group col-xs-12 col-sm-6 col-md-6 has-warning">
                                <label><i class="fa fa-check"></i>联系人电话</label>
                                <input type="text" class="form-control" name="liaison_phone" value="{{$info->liaison_phone}}"
                                       required>
                            </div>
                            <div class="form-group col-xs-12 col-sm-12 col-md-12">
                                <label>备注</label>
                                <textarea rows="3" class="form-control" name="remark">{{$info->remark}}</textarea>
                            </div>
                        </div>
